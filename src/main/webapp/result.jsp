...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-108131022-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-108131022-1');
    </script>
    ...
    <meta name="description" content="你明的/IG女神做雞逐個足/大吉大利 今晚吃雞!睇下你係唔係絕地求生高手 上載照片馬上知道你女朋友係唔係" />
    <meta name="keywords" content="大吉大利 今晚吃雞!睇下你係唔係絕地求生高手" />
    <meta name="author" content="PTGFHunter" />
    <meta name="robots" content="index, follow" />
    <meta name="googlebot" content="index, follow" />
    <meta name="URL" content="https://face-comparison.appspot.com/result.jsp">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="navbar-brand" href="upload.html">點擊這裡睇下你係唔係PUBG高手</a>
            </div>
        </div>
    </div>
</header>
                        ...
                        <c:forEach items="${courses}" var="courses">
                            <div class="item">
                                <div class="animate-box">
                                    <a href="${courses.key}" class="image-popup fh5co-board-img">
                                        <img src="${courses.key}" alt="Winner, Winner, Chicken Dinner"></a>
                                </div>
                                <div class="fh5co-desc">相似度:${courses.value}</div>
                            </div>
                        </c:forEach>
    ...
    <div class="container">
        <div class="row row-padded">
            <div class="col-md-12 text-center">
                ...
                <p><small>每次更新網頁顯示32張圖片<br>PTGF/CC 圖片總數:${totalNoOfRecords}</small></p>-->
            </div>
        </div>
    </div>
</footer>
